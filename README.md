...
| If user input singular word, program will check plural versions of the word, too. | W: cat <br/> S: I'm walking to the cathedral with my **_cats_**. One **_cat_** is running after birds.  | 2 |
| If user input plular word, progrma will only check the plural versions of the word. | W: cats <br/> S: I'm walking to the cathedral with my **_cats_**. One _cat_ is running after birds. | 1 |
